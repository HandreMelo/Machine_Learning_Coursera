...
h_Theta = sigmoid(z3);
a3 = h_Theta;
y_matrix = eye(num_labels)(y,:); %para cada coluna relativa ao numero de labels, é posto o numero 1 na coluna... ou seja cada coluna equivale a um numero das possiveis Outputs y.
